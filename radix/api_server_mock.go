...
func (mr *MockAPIServerMockRecorder) GetApplication(ctx, appName any) *gomock.Call {
...
func (mr *MockAPIServerMockRecorder) ShowApplications(ctx, sshURL any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIServerMockRecorder) TriggerPipeline(ctx, appName, gitRef, gitRefType, commitID, triggeredBy any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
