...
func (m *MockAPIServer) TriggerPipeline(ctx context.Context, appName, gitRefs, gitRefsType, commitID, triggeredBy string) (*models.JobSummary, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TriggerPipeline", ctx, appName, gitRefs, gitRefsType, commitID, triggeredBy)
...
func (mr *MockAPIServerMockRecorder) TriggerPipeline(ctx, appName, gitRefs, gitRefsType, commitID, triggeredBy interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TriggerPipeline", reflect.TypeOf((*MockAPIServer)(nil).TriggerPipeline), ctx, appName, gitRefs, gitRefsType, commitID, triggeredBy)
}
